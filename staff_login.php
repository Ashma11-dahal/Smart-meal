        ...
        <div class="login-body">
            ...
            <?php else: ?>
                ...
                <div class="staff-info">
                    <h4>📋 Authorized Staff Emails</h4>
                    <div class="staff-list">
                        <div>📧 admin@smartmeal.com (Admin)</div>
                        <div>📧 manager@smartmeal.com (Manager)</div>
                        <div>📧 staff1@smartmeal.com (Staff)</div>
                        <div>📧 staff2@smartmeal.com (Staff)</div>
                        <div>📧 staff3@smartmeal.com (Staff)</div>
                    </div>
                </div>
